        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <Input
              type="text"
              placeholder="Search"
              className="w-64 pl-10 pr-4 h-10 border-gray-300 rounded-full focus:border-primary focus:ring-primary font-inter"
            />
          ...
          {/* User Profile */}
          <div className="flex items-center space-x-3 bg-primary text-white px-4 py-2 rounded-full">
